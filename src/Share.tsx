...
const SetupComponent = () => {
  ...
  // Função de transição Landing -> Menu
  const handleEnter = () => {
    setIsExiting(true);
    setTimeout(() => {
      setHasEntered(true);
  ...
  return (
    <div className="setup-mobile-pro" style={{ 
      ...
      <style>{`
        ...
        .v-close-x { position: absolute; top: -8px; right: -8px; width: 22px; height: 22px; background: #1A1B1E; color: white; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 10px; font-weight: 800; border: 2px solid white; }
