      ...
      <div 
        ...
        onClick={() => {
          setPokemonData({
            ...
            name: result.name,
            set: result.set.name,
            // ESTE É O CAMINHO CORRETO PARA O LOGOTIPO ARTÍSTICO
      ...
      <div style={{ display: 'flex', gap: '8px', marginBottom: '10px', alignItems: 'center' }}>
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <div style={{ 
              position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)',
              width: '8px', height: '8px', borderRadius: '50%', backgroundColor: 'white', border: '2.5px solid #1c1c1e'
            }} />
          </div>
        </div>
      </div>
      ...
      {isSyncing && (
        <div style={{ 
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <p style={{ marginTop: '20px', fontWeight: '900', color: '#ee1515', letterSpacing: '2px' }}>A ADICIONAR À POKEDEX...</p>
          </div>
        </div>
      )}
      ...
      <div style={{ 
        ...
        <div style={{ position: 'relative', zIndex: 10, padding: '15px 20px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginTop: '10px' }}>
             {/* MASTER TRAINER RANK COM FORMA E COR AMARELA */}
             <div style={{ 
